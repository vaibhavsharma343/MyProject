...
public class AppSecretData {
    ...
    public static void main(String a[]) {
        System.out.println("this is 0: " + getDateTime(0,0));
        System.out.println("this is 1: " + getDateTime(1,1));
        System.out.println("this is 2: " + getDateTime(2,2));
        System.out.println("this is 3: " + getDateTime(3,3));

       // System.out.println(getNumber());

        System.out.println(ERROR_LOG("Error some error occured here"));
    ...
    public static String getDateTime(int dateStyle, int timeStyle) {
        Date dt = new Date();
        DateFormat dtf = DateFormat.getDateTimeInstance(dateStyle, timeStyle, Locale.of("en", "US"));
    ...
    public static String ERROR_LOG(String msg) {
        ...
        return ERROR_RED + "logs: " + getDateTime(3, 3) + " type: ERR " + msg;
    }


    public static String appLogs(String type, String msg) {
        return getDateTime(0, 0) + " " + type + " " + msg;
    }
}
