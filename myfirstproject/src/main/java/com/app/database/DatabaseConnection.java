...
public class DatabaseConnection {
	...
	static String DB_PASSWORD = AppSecretData.loadAppSecrets("MONGO_DB_PASSWORD", "en", "US");
	      ...
	      static String connectionString = "mongodb+srv://"+DB_USERNAME+":"+DB_PASSWORD+"@vaibhavfirstproject.5k2zcff.mongodb.net/?appName=vaibhavFirstProject";
		  ...
		  static ServerApi serverApi = ServerApi.builder()
			...
			public static boolean insertUserData(String fName, String lName, long phone, String userMail, String userPwd) {
				try {
